...
def main():
	...
	for i in range(1,1433):
		#Generate filename
		if(i<=9):
			filename = "../RoadMarkings/roadmark_000" + str(i) + ".jpg";
		elif(i>=10 and i<=99):
			filename = "../RoadMarkings/roadmark_00" + str(i) + ".jpg";
		elif(i>=100 and i<=999):
			filename = "../RoadMarkings/roadmark_0" + str(i) + ".jpg";
		else:
			filename = "../RoadMarkings/roadmark_" + str(i) + ".jpg";
			
		#read the image
		image = cv2.imread(filename)
		
		#detect it
		result = find_roadmarking(image)
		
		#Display results
		cv2.imshow('RoadMarkings', result)
		cv2.waitKey(10)

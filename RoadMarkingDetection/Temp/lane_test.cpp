...
Mat reg_of_interest(Mat img)
{
	...
	Point vertex[1][4];
	vertex[0][0]=Point(95,528);
	vertex[0][1]=Point(333,379);
	vertex[0][2]=Point(586,373);
	vertex[0][3]=Point(843,531);
	...
	for( size_t i = 0; i < lines.size(); i++ )
	 {
		...
		line(d_img,Point(x1,y1),Point(x2,y2),Scalar(0,0,255), 3, 8 );
...
{
	VideoCapture cap("/home/raj/Github/Computer-Vision-5561-Project/lane_detect_1_video/Test_1.avi");

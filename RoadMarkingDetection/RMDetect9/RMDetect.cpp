...
int main() 
{
	...
	// Read video
	VideoCapture cap("../Video/Test.avi");
	if(!cap.isOpened())
	{
	...
	while(1)
	{
		...
		// Draw ROI on img
		line(img_src, Point(843, 663), Point(1032, 663), Scalar(0, 0, 255), 2, 8);
		line(img_src, Point(1032, 663), Point(1648, 1030), Scalar(0, 0, 255), 2, 8);
		line(img_src, Point(1648, 1030), Point(274, 1030), Scalar(0, 0, 255), 2, 8);
		line(img_src, Point(274, 1030), Point(843, 663), Scalar(0, 0, 255), 2, 8);
